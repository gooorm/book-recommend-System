...
# 페이지 설정
st.set_page_config(page_title="보행자 최단 경로 찾기", layout="wide")

# 제목
st.title("🚶 보행자 최단 경로 찾기 시스템")
st.markdown("### OpenStreetMap 데이터 기반 경로 탐색 알고리즘")
...
# 경로 찾기 버튼
if st.sidebar.button("🔍 경로 찾기", type="primary"):
